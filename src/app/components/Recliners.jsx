...
import { recliners } from '../helpers/helpers';
...
function Recliners() {
  ...
  return (
    <div className='px-2'>  
        <div className='flex items-start justify-center py-5'><h1 className='font-semibold text-2xl text-teal-600'>Recliners</h1></div>   
